...
print_header("Include some additional graph statistics about Young Guns", "killr.movies('Young Guns').enrich(True, keys(KEY_TITLE, KEY_YEAR), in_degree(), out_degree())")
for r in killr.movies("Young Guns").enrich(True, keys(KEY_TITLE, KEY_YEAR), in_degree(), out_degree()).toList():
    print(r)
