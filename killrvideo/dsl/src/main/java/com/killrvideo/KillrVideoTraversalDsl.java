...
public interface KillrVideoTraversalDsl<S, E> extends GraphTraversal.Admin<S, E> {
    ...
    public default GraphTraversal<S, Vertex> ensurePerson(String personId, String name) {
        ...
        return choose(__.V().has(VERTEX_PERSON, KEY_PERSON_ID, personId),
                      __.V().has(VERTEX_PERSON, KEY_PERSON_ID, personId),
                      __.addV(VERTEX_PERSON).
                          property(KEY_PERSON_ID, personId)).
